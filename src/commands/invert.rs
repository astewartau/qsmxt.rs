...
pub fn execute(args: InvertArgs) -> crate::Result<()> {
    ...
    let chi: Vec<f64> = match args.algorithm {
        QsmAlgorithmArg::Rts => qsm_core::inversion::rts(
            &field_nifti.data, &mask,
            nx, ny, nz, vsx, vsy, vsz,
            bdir,
            args.rts_delta, args.rts_mu, 10.0,
            args.rts_tol, 20, 4,
        ),
        ...
        QsmAlgorithmArg::Tgv => {
            ...
            let params = qsm_core::inversion::TgvParams {
                iterations: args.tgv_iterations,
                erosions: args.tgv_erosions,
                fieldstrength: fs as f32,
                te: te as f32,
                ..Default::default()
            };
